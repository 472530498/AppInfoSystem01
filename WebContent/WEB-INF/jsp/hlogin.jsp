...
<!-- Font Awesome -->
<link
	href="<%=request.getContextPath()%>/statics/css/font-awesome.min.css"
	rel="stylesheet">
<!-- NProgress -->
<link
	href="<%=request.getContextPath()%>/statics/css/nprogress/nprogress.css"
	rel="stylesheet">
<!-- Animate.css -->
<link href="<%=request.getContextPath()%>/statics/css/animate.min.css"
	rel="stylesheet">

<!-- Custom Theme Style -->
<link href="<%=request.getContextPath()%>/statics/css/custom.min.css"
	rel="stylesheet">
</head>
	...
	<div>
		...
		<div class="login_wrapper">
			<div class="animate form login_form">
				...
				<form action="${pageContext.request.contextPath}/user/adminlogin"
					method="post">
					<h1>后台管理系统</h1>
					<div>
			...
			<div id="register" class="animate form registration_form">
				...
				<form>
					...
					<div class="separator">
						<p class="change_link">
							Already a member ? <a href="#signin" class="to_register"> 登录
							</a>
						</p>
