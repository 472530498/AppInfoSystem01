                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> APP管理 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="index.html">查看APP列表信息</a></li>
                      <li><a href="index2.html">增加APP基础信息</a></li>
                  ...
                  <li><a href="javascript:void(0)"><i class="fa fa-laptop"></i> 主页 <span class="label label-success pull-right">点击</span></a></li>
                </ul>
              </div>
